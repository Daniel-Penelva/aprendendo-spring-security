...
public class SecurityConfig {
    ...
    /* A segurança é feito através de filtros (filter), ou seja, a requisição web passa pelo filtro ( o filter intercepta a requisição e checa 
    se já é autenticada ou não, senão não for autenticado nem entra no controller) que modifica e transforma numa requisição adequada que será 
